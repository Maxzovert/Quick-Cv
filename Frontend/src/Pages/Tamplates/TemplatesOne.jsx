...
const TemplatesOne = () => {
    const [Templet , setTemplet] = useState("One")
  ...
  >
    <div ref={printElem}>
      ...
      >
        <HStack spacing={1}>
          <MdMail />{" "}
          <Text>{about.email ? about.email : "example@gmail.com"}</Text>
        </HStack>
        <HStack spacing={1}>
          <MdLocalPhone />{" "}
          <Text>{about.phone ? about.phone : "+91999999999"}</Text>
        </HStack>
        <HStack spacing={1}>
          <MdLocationPin />{" "}
          <Text>{about.address ? about.address : "Delhi, Delhi"}</Text>
        </HStack>
        <HStack spacing={1}>
          <RiLinkedinBoxFill />{" "}
